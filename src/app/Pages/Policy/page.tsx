  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-8 py-10 md:border-2 border-black mt-10 mb-10 rounded-xl text-[#222]">
      ...
      <div className="space-y-6 text-base md:text-lg leading-relaxed text-justify">
        ...
        <h2 className="text-xl md:text-2xl font-bold mt-8">Information We Collect</h2>
        <p>
        ...
        <h2 className="text-xl md:text-2xl font-bold mt-8">How We Use Your Information</h2>
        ...
        <h2 className="text-xl md:text-2xl font-bold mt-8">Data Protection</h2>
        <p>
        ...
        <h2 className="text-xl md:text-2xl font-bold mt-8">Cookies</h2>
        <p>
        ...
        <h2 className="text-xl md:text-2xl font-bold mt-8">Third-Party Disclosure</h2>
        <p>
        ...
        <h2 className="text-xl md:text-2xl font-bold mt-8">Your Consent</h2>
        <p>
          By using our site, you consent to our privacy policy.
        </p>

        <h2 className="text-xl md:text-2xl font-bold mt-8">Changes to Our Privacy Policy</h2>
        <p>
