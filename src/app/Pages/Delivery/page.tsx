  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-8 py-10 border-2 border-black mt-10 rounded-xl text-[#222]">
      ...
      <div className="space-y-6 text-base md:text-lg leading-relaxed text-justify">
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-6">Order Processing</h2>
        <p>
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-6">Delivery Time</h2>
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-6">Shipping Charges</h2>
        <p>
          We offer <strong>Resonable Shipping Worldwide</strong> on all orders.
        </p>

        <h2 className="text-xl md:text-2xl font-semibold mt-6">Order Tracking</h2>
        <p>
          Once your order is shipped, a tracking number will be emailed to you so you can monitor your shipment’s progress.
        </p>

        <h2 className="text-xl md:text-2xl font-semibold mt-6">Delivery Delays</h2>
        <p>
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-6">Customs Duties & Taxes</h2>
        <p>
